package com.springboot.example.code;
...
public class InviteCode {
    public static void main(String[] args){
       ...
       for (int i=10;i<100000;i++){
           //System.out.println(toSerialCode(i).toUpperCase());
           String inviteCode = toSerialCode(i).toUpperCase();
           boolean flag = inviteCodeSet.add(inviteCode);
           if (!flag){
    ...
    public void parseInviteCode(){
        System.out.println(codeToId("89AWCZ"));
    }
